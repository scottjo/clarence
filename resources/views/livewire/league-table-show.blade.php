        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900/50">
                        <tr>
                            ...
                            <th scope="col" class="px-3 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">RW</th>
                            <th scope="col" class="px-3 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">RD</th>
                            <th scope="col" class="px-3 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">RL</th>
                            <th scope="col" class="px-3 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">F</th>
                            <th scope="col" class="px-3 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">A</th>
                            <th scope="col" class="px-3 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Diff</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($standings as $index => $standing)
                            <tr class="{{ $loop->even ? 'bg-gray-50/50 dark:bg-gray-900/20' : '' }} hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors">
                                ...
                                <td class="px-3 py-4 whitespace-nowrap text-sm text-center font-medium {{ $standing->points_difference >= 0 ? 'text-green-600 dark:text-green-500' : 'text-red-600 dark:text-red-500' }}">
            ...
            <div class="px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 text-center">
                <p class="text-xs text-gray-500 dark:text-gray-400 italic">
                    <span class="font-bold">Legend:</span> P: Played, W: Won, D: Drawn, L: Lost, RW: Rinks Won, RD: Rinks Drawn, RL: Rinks Lost, F: For, A: Against, Diff: Shot Difference, Pts: Points
                </p>
                @if($league->message)
