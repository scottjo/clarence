                ...
                Section::make('Book a Rink Advert')
                    ...
                    ->schema([
                        ...
                        Textarea::make('book_a_rink_description')
                            ->label('Description')
                            ->placeholder('Fancy a casual game? Book a rink and enjoy a session at Clarence Bowling Club. Equipment can be provided. Just wear flat soled shoes')
                            ->rows(3)
                            ->columnSpanFull()
                            ->visible(fn (Get $get) => $get('book_a_rink_advert_enabled')),
    ...
    public function save(): void
    {
        try {
            ...
            $regularData = array_replace([
                ...
                'book_a_rink_description' => 'Fancy a casual game? Book a rink and enjoy a session at Clarence Bowling Club. Equipment can be provided. Just wear flat soled shoes',
