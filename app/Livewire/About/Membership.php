...
class Membership extends Component
{
    public function render(): View
    {
        ...
        return view('livewire.about.membership', [
            ...
            'title' => 'Join Clarence Bowling Club | Lawn Bowls in Weston-super-Mare',
            'metaDescription' => 'Join Clarence Bowling Club in Weston-super-Mare. Explore our membership types and benefits for the '.date('Y').' season.',
        ]);
    }
}
